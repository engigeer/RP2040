...
#define SPINDLE_PWM_PORT        GPIO_OUTPUT // Spindle PWM (2 pin PWM port)
#define SPINDLE_PWM_PIN         25
#else
#define AUXOUTPUT0_PWM_PORT     GPIO_OUTPUT
#define AUXOUTPUT0_PWM_PIN      25
#endif
...
#define AUXINPUT1_PIN           5 // CNC shield RUN pin
#define AUXINPUT2_PIN           10 // CNC shield A4 (ADC capable, 3.3V max)
